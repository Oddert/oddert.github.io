    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("i", { className: "fa fa-cog fa-5x fa-spin" })
        )
      )
    );
  }
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "p",
              null,
              "Utilizing an artificial intelligence network based on the ARIES modeler, the Network for Global Ecomodeling Sustainability Research is a platform for global ecological computational modelling. The Something platform collaboratively connects individuals and organisations for the purpose of research and enacting policy change to push for a fully sustainable future."
            ),
            React.createElement(
              "p",
              null,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: "pageThree-callToAction-button btn btn-default" },
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: "btn btn-default pageFour-button" },
...
ReactDOM.render(React.createElement(Construction, null), document.getElementById('popup'));